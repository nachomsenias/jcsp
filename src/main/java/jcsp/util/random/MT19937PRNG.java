 ...
 * Link		: http://www.math.sci.hiroshima-u.ac.jp/~m-mat/MT/VERSIONS/JAVA/MTRandom.java
 * 
 ...
 * 
 */
public strictfp class MT19937PRNG extends Random implements Randomizer {
	 ...
	 * behaviour.
	 */
	public MT19937PRNG(boolean compatible) {
		super(0L);
		compat = compatible;
		setSeed(compat ? DEFAULT_SEED : RandomizerUtils.generateRandomSeed() );
	}
